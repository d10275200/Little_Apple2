...
import com.nol.ivan.little_apple2.Fragment.MainFragment;
import com.nol.ivan.little_apple2.Fragment.ProfileFragment;
import com.nol.ivan.little_apple2.Fragment.ReadmeFragment;
import com.nol.ivan.little_apple2.Fragment.TabFragment;
import com.nol.ivan.little_apple2.Fragment.TaskFragment;
import com.nol.ivan.little_apple2.Network.VolleyController;
...
//        contentView.setText(menuItem.getTitle());
    ...
    private void create_write(){
        ...
        final String[] Pop_sex = {""};
        RadioGroup radioGroup = (RadioGroup) v1.findViewById(R.id.pop_radiogroup);
        final RadioButton pop_man = (RadioButton) v1.findViewById(R.id.pop_man_radio);
        final RadioButton pop_woman = (RadioButton) v1.findViewById(R.id.pop_woman_radio);
        //pop_man.setChecked(true);

        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == pop_man.getId()){
                    Pop_sex[0] = "Man";
                } else if (checkedId == pop_woman.getId()){
                    Pop_sex[0] = "Woman";
                }
            }
        });
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if ("".equals(Pop_name)) {
                        ...
                        } else if ("".equals(Pop_sex[0])) {
                            Toast.makeText(MainActivity.this, "sex can't be empty", Toast.LENGTH_LONG).show();
                            try {
                                Field field = dialog.getClass().getSuperclass().getDeclaredField("mShowing");
                                field.setAccessible(true);
                                field.set(dialog, false);
                            ...
                            String SEX = Pop_sex[0];
                            Create_User(t_id, Pop_name, Pop_height, Pop_weight, Pop_age, SEX);

                            editor.putString("Name", Pop_name);
                            editor.putString("Weight", Pop_weight);
                            editor.putString("Height", Pop_height);
                            editor.putString("Age", Pop_age);
    ...
    private String Create_User(final String User_id,final String Name, final String Height, final String Weight, final String Age, final String Sex){
        RequestQueue mQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://140.113.203.226/~Ivan/InsertLittleAppleUser.php",  new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...
//        int icon = 0;
        ...
        if(type == 0) {
            v2 = inflater2.inflate(R.layout.calibration_z, null);
//            Title = "請將拍子垂直朝下";
//            Message = "請依示意圖放置";
//            icon = R.drawable.calibration_z;
            TypeTemp = LogFileWriter.CALIBRATION_Z_TYPE;
        }
        else {
            v2 = inflater2.inflate(R.layout.calibration_y, null);
//            Title = "請將拍子水平放置";
//            Message = "請依示意圖放置";
//            icon = R.drawable.calibration_y;
            TypeTemp = LogFileWriter.CALIBRATION_Y_TYPE;
        }

        AlertDialog.Builder CalZDialog = new AlertDialog.Builder(MainActivity.this);
        CalZDialog.setView(v2)
                .setCancelable(false)
    ...
    private void showAxisCalibrationProcessDialog(final int LogType) {
        final ProgressDialog Cal_dialog = ProgressDialog.show(MainActivity.this, "校正中", "儲存中，請稍後",true);
